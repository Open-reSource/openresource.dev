...
authors: julien
cover: /covers/get-real-time-github-stars-notifications-in-discord.svg
tags:
  - Automation
  - Discord
  - Discord Webhook
...
> If you're not familiar with GitHub Actions, it allows you to automate workflows directly in your GitHub repository, and it can be triggered based on various events. More information can be found in the [GitHub Actions documentation](https://docs.github.com/en/actions).
...
> [!WARNING] Be mindful of the GitHub API rate limits
