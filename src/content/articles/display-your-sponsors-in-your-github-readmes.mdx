...
authors: julien
cover: /covers/display-your-sponsors-in-your-github-readmes.svg
tags:
  - GitHub
  - Sponsors
  - Tutorial
...
It can be changed by going to your repository settings, then to the "Actions" section, and choose "Read and write permissions" for the "Workflow permissions" option.
...
By looking at `.github/workflows/scheduler.yml`, we can see that it relies on a `${{ secrets.SPONSORS_TOKEN }}` environment variable.
...
You can find more information about how to create a new repository secret in the [GitHub documentation](https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets#creating-secrets-for-a-repository).

### Configure the GitHub Action

Either after having cloned your repository locally, or directly on GitHub, you will need to edit the `.github/workflows/scheduler.yml` to indicate your GitHub username as a value for "SPONSORKIT_GITHUB_LOGIN".
