...
authors: julien
cover: /covers/running-a-local-ai-inside-obsidian-with-ollama.svg
tags:
  - AI
  - Tools
  - Tutorial
...
import { Steps } from '@deramond.dev/astro';
...
1. In Obsidian, go to "Settings → Community Plugins → Browse" and search for "AI Providers".
   ...
   <ContentImage
   	src="/images/running-a-local-ai-inside-obsidian-with-ollama-1.webp"
   	alt="Obsidian’s community plugin browser: a search for “AI Providers”, the plugin by Pavel Frankov and its Install button."
   	width="720"
   	height="320"
   />
...
1. Click "Options" to configure the plugin:
   ...
   <ContentImage
   	src="/images/running-a-local-ai-inside-obsidian-with-ollama-2.png"
   	alt="The “Add new provider” dialog: type Ollama, URL http://localhost:11434, model gemma4:latest."
   	width="420"
   	height="320"
   />
...
1. In Obsidian, go to "Settings → Community Plugins → Browse" and search for "Local GPT".
   ...
   <ContentImage
   	src="/images/running-a-local-ai-inside-obsidian-with-ollama-3.webp"
   	alt="Obsidian’s community plugin browser: a search for “local gpt”, with Local GPT by Pavel Frankov selected."
   	width="720"
   	height="320"
   />
...
1. Click "Options" to configure the plugin:
   ...
   <ContentImage
   	src="/images/running-a-local-ai-inside-obsidian-with-ollama-4.png"
   	alt="Local GPT options: the main, embedding and vision AI providers all set to “Ollama ~ gemma4:latest”."
   	width="720"
   	height="320"
   />
...
1. Assign hot keys to the following commands:
   ...
   <ContentImage
   	src="/images/running-a-local-ai-inside-obsidian-with-ollama-5.png"
   	alt="Obsidian hotkeys filtered on “local”: Action Palette on ⌘ J, Show context menu on ⌘ M."
   	width="720"
   	height="320"
   />
...
1. Press the hot key you assigned for "Local GPT: Show context menu" (e.g., <kbd>⌘ + M</kbd>). It will open a context menu with various AI actions you can perform on the selected text:
   ...
   <ContentImage
   	src="/images/running-a-local-ai-inside-obsidian-with-ollama-6.png"
   	alt="The Local GPT context menu in a note: General help, Continue writing, Summarize, Fix spelling, Find action items."
   	width="720"
   	height="320"
   />
...
<ContentImage
	src="/images/running-a-local-ai-inside-obsidian-with-ollama-7.png"
	alt="A note with the whole article selected and the Local GPT context menu open on Summarize."
	width="420"
	height="320"
/>
...
<ContentImage
	src="/images/running-a-local-ai-inside-obsidian-with-ollama-8.png"
	alt="The summary written at the end of the note: a heading, a short intro, and bullet points on setup, privacy and trade-offs."
	width="420"
	height="320"
/>
...
<ContentImage
	src="/images/running-a-local-ai-inside-obsidian-with-ollama-9.png"
	alt="The Local GPT action palette over a GitHub logo in a note, with the prompt “Describe this image!”."
	width="420"
	height="320"
/>
...
<ContentImage
	src="/images/running-a-local-ai-inside-obsidian-with-ollama-10.png"
	alt="The description written under the GitHub logo: overall, elements (the cat silhouette, the word GitHub) and style."
	width="420"
	height="320"
/>
