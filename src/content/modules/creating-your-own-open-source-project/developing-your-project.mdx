...
But wait! Before you do that, you might want to clean up your code a little bit and set up some commit messages guidelines before such as [Convential Commits](https://www.conventionalcommits.org). You won't regret it!
