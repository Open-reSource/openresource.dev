...
3. **Starter Issues and First-Timer-Friendly Tasks** by labeling issues as "good first issue" helps new contributors find tasks that match their skill level and confidence. Folks will follow guide like our ["Finding Open-Source Projects" module](/guide/contributing-to-open-source-projects/finding-open-source-projects) to find projects to contribute to; you can adapt your project to follow what we suggest in that guide but from the maintainer's perspective.
