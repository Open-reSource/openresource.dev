...
- [Up For Grabs](https://up-for-grabs.net/) is a list of projects which have curated tasks specifically for new contributors. They gather projects that actively want help and label some of their issues with known labels like "up-for-grabs", "good first issue", "help wanted", etc. You can filter projects by programming languages, difficulty level, and more.
