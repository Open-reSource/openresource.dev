...
<ShowcaseGitHubRepo env="freeCodeCamp" repo="freeCodeCamp" img="9892522" description="freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free." />
