...
<Chat type="end" author="Maintainer">
  Hello! As mentioned in <span style="text-decoration: underline">our contributing guidelines</span>, we do not assign issues in this repository. However, if you'd like to contribute a solution, feel free to create a PR directly. Thank you for your interest!
</Chat>
...
<ShowcaseGitHubRepo env="Open-reSource" repo="labs-append-markdown-to-issues" img="129324099" description="[Labs] Automatically append Markdown to issues" />
...
<ShowcaseGitHubRepo env="Open-reSource" repo="labs-we-don-t-assign-issues" img="129324099" description="[Labs] &quot;we don't assign issues&quot; label that writes a comment and is then auto-deleted" />
