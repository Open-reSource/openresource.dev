...
{/* prettier-ignore */}
<strong style="color: var(--sl-color-text-accent); font-size: 1.25rem; line-height: 1.75rem;">This is a frustrating experience for both the contributor and the maintainer</strong>.
...
{/* prettier-ignore */}
<strong style="color: var(--sl-color-text-accent); font-size: 1.25rem; line-height: 1.75rem;">If issues are assigned, make sure that it's clearly explained in the Contributing Guidelines</strong>.

{/* prettier-ignore */}
<strong style="color: var(--sl-color-text-accent); font-size: 1.25rem; line-height: 1.75rem;">If issues are not assigned, make sure that it's clearly explained in the Contributing Guidelines</strong>.
