...
<ShowcaseGitHubRepo env="antfu" repo="sponsorkit" img="11247099" description="💖 Toolkit for generating sponsors images 😄" />
...
<ShowcaseGitHubRepo env="Open-reSource" repo="sponsorkit-starter" img="129324099" description="Starter template for SponsorKit" />
