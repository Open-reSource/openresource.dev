...
{/* prettier-ignore */}
<p class="lead">In open source, crafting a distinct project identity is more than a mere formality—it's the secret sauce that sets your creation apart. It's not just about the content; it's about giving your project a personality that resonates.</p>

<InShort>

- Write your values down before the name and the logo: every later choice gets checked against them.
- Pick a name that's short, says what the project does, and is free: domain, GitHub and GitLab, trademarks.
- Design a logo that works as a favicon and on a conference banner, then write a style guide: logo, colors, fonts.
- The homepage says what the project is, what it solves, and how to contribute.
- Identity is also the people: the community culture, the posts, the talks. Be the same project everywhere.
...
<Checklist id="building-a-strong-project-identity">
...
- [Building Welcoming Communities](https://opensource.guide/building-community/) and [Finding Users for Your Project](https://opensource.guide/finding-users/), in GitHub's Open Source Guides: the community and outreach half of this chapter, in more depth.
- [The Art of Community](https://www.jonobacon.com/books/artofcommunity/) by Jono Bacon: the book on building communities around open-source projects, free under a Creative Commons license.
