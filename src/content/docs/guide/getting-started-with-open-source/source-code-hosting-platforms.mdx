...
<p class="lead">
	Source code hosting platforms are the backbone of the open source community,
	facilitating collaboration, version control, and project management.
</p>
...
<p class="lead">
	When exploring these platforms, remember that each has its own unique features
	and user base. You can find a wide variety of projects on all of them, but
	GitHub and GitLab tend to be the most popular choices among developers.
</p>
