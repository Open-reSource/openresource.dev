...
[OSI-approved licenses](https://opensource.org/licenses/) are widely recognized and respected, and they are often used as a reference for the open source community. They include the most popular ones: MIT, Apache 2.0, the GPL family and MPL 2.0.
