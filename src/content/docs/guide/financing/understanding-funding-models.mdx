...
{/* prettier-ignore */}
<p class="lead">An open-source project can be funded six ways: donations, sponsorships, crowdfunding, corporate partnerships, subscriptions and grants. Each comes with its own strings attached. Most funded projects combine several, so that losing one source doesn't stop the work.</p>
...
- **Dependence**: Over-reliance on sponsors can create vulnerability if support is withdrawn. Diversify.
...
- **Dependence:** Risk of over-reliance on a single corporate partner. Diversify.
