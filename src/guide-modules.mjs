...
// (`<dir>/<page>`): its URLs, old folder included, get a 301 there.
export const modules = [
	...
	},
	{
		...
		pages: ['source-code-hosting-platforms'],
		merged: { 'finding-open-source-projects': 'contributing/finding-open-source-projects' },
	},
	{
		label: 'Contributing',
		dir: 'contributing',
